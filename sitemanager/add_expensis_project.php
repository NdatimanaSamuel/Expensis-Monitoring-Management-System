...
<body id="page-top">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="homeSiteManager.php">Dashboard</a>
          </li>
          <li class="breadcrumb-item active">Create New Expenses To Project</li>
        </ol>

        <!-- Page Content -->
        <h5>Request New Expense on Project</h5>
        <hr>
             <div class="container">
    <div class="card card-register mx-auto mt-2">
      <div class="card-header">Request Expense</div>
      <div class="card-body">   
 <form action="" method="POST">
                  ...
                  <div class="form-group">
                    <div class="form-row">
                        <div class="col-md">
                      <label for="sdate">Cost :</label>
                       <input class="form-control input-sm" id="sdate" name="expense_cost"  type="number" required>
                      </div>
                    </div>
                  </div>
                 ...
                 <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="edate">Item Name:</label>
                         <input class="form-control input-sm" id="edate" name="item_name"  type="text" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="col-md">
                      <label for="projectcost">Requested On:</label> 
                         <input class="form-control input-sm" id="projectcost" name="request_on"  value="<?php echo date("Y-m-d");?>" type="date" readonly="">
                      </div>
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="projectcost">Describe Expense:</label>
                         <input class="form-control input-sm" id="projectcost" name="describe_expense"  type="text" required step=".01" min="0">
                      </div>
                    </div>
                  </div>
         
            <button class="btn btn-primary btn-block" name="save_project_expense" type="submit" ><span class="glyphicon glyphicon-floppy-save"></span> Save Project Expense</button>
...
if (isset($_POST['save_project_expense'])) {
...
$row = mysqli_num_rows($query);
   ...
   while ($data  = mysqli_fetch_array($query)) {
             ...
             $remaindmoney=$data['remaindmoney'];
             $StatusProject=$data['project_status'];
             
             $AccountStatuss=$data['accountentstatus'];
             $SiteManagerStatus=$data['sitestatus'];
        }

if ($StatusProject=="FINISHED") {

   echo"<script>alert('Please This Project Is Already Finished');</script>"; 

      exit();
}

if ($AccountStatuss=="Pending") {

   echo"<script>alert('Please This Project Is Not Accepted By Accountant');</script>"; 

      exit();
}

if ($SiteManagerStatus=="Pending") {

   echo"<script>alert('Please This Project Is Not Accepted By Site Manager');</script>"; 
 ...
 if ($project_cost < $expense_cost) {
        echo"<script>alert('Please Project Cost Is Fewer Than This Entered ExpensisCost');</script>"; 

      exit();
         }
         

          if ($remaindmoney < $expense_cost) {
        echo"<script>alert('Please Your Remain Money is Less Than This ExpenseCost');</script>"; 

      exit();
         }

      if ($expense_cost==0) {
        echo"<script>alert('Please Enter Valid Expense Cost Not Zero');</script>"; 
 ...
 exit();
    ...
    $SiteManager=$fetch['sitemananame'];
   $AccountName=$fetch['acountentname'];
   
                                 

$insert=mysqli_query($conn,"INSERT INTO expense(project_id,expense_type,expense_item,seller,date_given,expense,requesteby,accountent,describe_expense,done_by,donestatus)
  VALUES('$project_id','$expense_type','$item_name','$seller_name','$request_on','$expense_cost','$SiteManager','$AccountName','$describe_expense','$doneBY','Pending')");
...
echo " <script>window.alert('Expenses Sent Successful  ');window.location='viewProject.php'</script>";
}
