                  ...
                  <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="sdate">Start Date:</label>
                       <input class="form-control input-sm" id="sdate" name="startdate" value="<?php echo $fetch['startdate']?>" type="date" readonly="">
                      </div>
                    </div>
                  </div>
                 ...
                 <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="edate">End Date:</label>
                         <input class="form-control input-sm" id="edate" name="enddate" value="<?php echo $fetch['enddate']?>"  type="date" readonly="">
                      </div>
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="projectcost">Project Cost:</label>
                         <input class="form-control input-sm" id="projectcost" name="projectcost" value="<?php echo $fetch['project_cost']?>" type="number" readonly="">
                      </div>
                    </div>
                  </div>
                    <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="projectcost">Describe Project:</label>
                         <input class="form-control input-sm" id="projectcost" name="describeproject" value="<?php echo $fetch['describeproject']?>" type="text" readonly="">
                      </div>
                    </div>
                  </div>
...
$conn->query("UPDATE `project` SET `accountentstatus`='$Status' WHERE `project_id` = '$ID'") or die(mysqli_error());
echo " <script>window.alert('successful Project Updated');window.location='viewPendingProject.php'</script>";
