  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Update Exists Project</li>
        </ol>

        <!-- Page Content -->
        <h3>Update Exists Project</h3>
        <hr>
        <div class="container">
    <div class="card card-register mx-auto mt-2">
                                     ...
                                     $fetch = $query->fetch_array();
                                      ?>
      <div class="card-header">Modify Project</div>
      <div class="card-body">   
                    ...
                    <div class="form-row">
                      ...
                      <label for="name">Project Name:</label>
                        ...
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="name" name="projectname" value="<?php echo $fetch['project_name']?>" placeholder=
                  ...
                  <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="sdate">Start Date:</label>
                       <input class="form-control input-sm" id="sdate" name="startdate" value="<?php echo $fetch['startdate']?>" type="date" required>
                      </div>
                    </div>
                  </div>
                 ...
                 <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="edate">End Date:</label>
                         <input class="form-control input-sm" id="edate" name="enddate" value="<?php echo $fetch['enddate']?>"  type="date" required>
                      </div>
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="projectcost">Project Cost:</label>
                         <input class="form-control input-sm" id="projectcost" name="projectcost" value="<?php echo $fetch['project_cost']?>" type="number" required step=".01" min="0">
                      </div>
                    </div>
                  </div>
                    <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="projectcost">Describe Project:</label>
                         <input class="form-control input-sm" id="projectcost" name="describeproject" value="<?php echo $fetch['describeproject']?>" type="text" required step=".01" min="0">
                      </div>
                    </div>
                  </div>
...
$conn->query("UPDATE `project` SET   `project_name`='$Projectname',`startdate` = '$Startdate', `enddate` = '$Enddate',`project_cost`='$Projectcost' ,`project_status`= '$Status',`describeproject`='$DescribeProject' WHERE `project_id` = '$ID'") or die(mysqli_error());
echo " <script>window.alert('successful Project Updated');window.location='viewProject.php'</script>";
