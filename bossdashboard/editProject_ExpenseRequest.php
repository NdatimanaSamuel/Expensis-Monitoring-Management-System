...
<body id="page-top">
 ...
 <form action="" method="POST">
    ...
    <input type="hidden" name="expense_cost" value="<?php echo $fetch['expense']?>">
...
if (isset($_POST['update_project'])) {
   ...
   $t=date("Y-m-d");
    ...
    $query = $conn->query("SELECT * FROM `project` WHERE `project_id` ='$ProjectId'") or die(mysqli_error());
    $fetch = $query->fetch_array();
...
$conn->query("UPDATE `project` SET   `project_expense`='$totalExpenseMoney' ,`remaindmoney`='$remainingmoney'WHERE `project_id` = '$ProjectId'") or die(mysqli_error());
