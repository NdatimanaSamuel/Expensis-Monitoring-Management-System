    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Create New Expenses</li>
        </ol>
                           ...
                           <input class="form-control input-sm" id="item" name="item" placeholder=
                            "Expense Name" type="text" value="" required>
                               ...
                               <?php $Random_code=rand(); ?>
                                ...
                                <input type="hidden" name="common_code" value="<?php echo $Random_code; ?>" />
                                <!-- <input type="hidden" name="code" value="Type  Code " required  /> -->
                               </div>
                                </div>
             
            <button class="btn btn-primary btn-block" name="save_expensis" type="submit" ><span class="glyphicon glyphicon-floppy-save"></span> Save Expense</button>
...
if (isset($_POST['save_expensis'])) {


   $category=$_POST['category'];
  $ExpenseName=$_POST['item'];
   $ExpenseCode=$_POST['common_code'];
   
   
$sql = "SELECT * FROM common_expense WHERE  listname='$ExpenseName' ";
$query = mysqli_query($db, $sql);
$row = mysqli_num_rows($query);

if ($row>0) {
 echo"<script>alert('ExpenseName is Exist');</script>"; 
...
$insert=mysqli_query($db,"INSERT INTO common_expense(common_code,category,listname)
  VALUES('$ExpenseCode','$category','$ExpenseName')");
...
echo " <script>window.alert('successful Expenses registed');window.location='viewExpensis.php'</script>";
}
