                  ...
                  <div class="form-group">
                    ...
                    <div class="form-row">
                      ...
                      <label for="projectcost">Requested By:</label>
                         <input class="form-control input-sm" id="projectcost" name="request_by" value="<?php echo $fetch['requesteby']?>" type="text" required step=".01" min="0">
                      </div>
                    </div>
                  </div>
...
$conn->query("UPDATE `project` SET  `project_expense`='$expense_cost' WHERE `project_id` = '$project_id'") or die(mysqli_error());
