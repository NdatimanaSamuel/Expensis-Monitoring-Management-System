  ...
  <div id="wrapper">
   ...
   <div class="container">
    ...
    <div class="card card-register mx-auto mt-2">
                                     ...
                                     $query = $conn->query("SELECT * FROM `account` WHERE `user_id` ='$ID'") or die(mysqli_error());
 ...
 <form action="" method="POST" >
                    ...
                    <div class="form-row">
                      ...
                      <label for="SUPNAME">Full Name:</label>
                       <input class="form-control input-sm"  name="fullname"  value="<?php echo $fetch['fullname']?>" required="" placeholder=
                 ...
                 <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="SUPTIN">Email:</label>
                       <input class="form-control input-sm" id="SUPTIN" name="email"  value="<?php echo $fetch['email']?>"  required="" placeholder=
                            " Email" type="email" >
                   ...
                   <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="SUPTIN">Address:</label>
                       <input class="form-control input-sm"  name="address" value="<?php echo $fetch['address']?>"  required="" placeholder=
                            " Address" type="text" >
                   ...
                   <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="SUPTIN">Telephone Contact:</label>
                       <input class="form-control input-sm" maxlength="14" name="phone"value="<?php echo $fetch['phone']?>"  required="" placeholder=
                            " Contact" type="text" >
            ...
            <button class="btn btn-primary btn-block" name="update_admin" type="submit" value="Register" ><span class="glyphicon glyphicon-floppy-save"></span> Update Profile</button>
...
if (strlen($PhoneNumber)>14) {
    ...
    exit();
        ...
        $conn->query("UPDATE `account` SET   `fullname`='$FullName',`email` = '$Email', `phone` = '$PhoneNumber',`password`='$Password' ,`type`='$Role',`address`= '$Address' WHERE `user_id` = '$ID'") or die(mysqli_error());

        echo '<script>alert("Profile Updated");window.location=\'viewUser.php\';</script>';
