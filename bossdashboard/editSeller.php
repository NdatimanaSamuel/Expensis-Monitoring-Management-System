...
<body id="page-top">
  ...
  <div id="wrapper">
   ...
   <div class="container">
          ...
          <div class="container">
                                     ...
                                     $query = $conn->query("SELECT * FROM `seller` WHERE `seller_id` ='$ID'") or die(mysqli_error());
                                     $fetch = $query->fetch_array();
                                      ?>
    <div class="card card-register mx-auto mt-2">
      <div class="card-header">Update Exists Seller</div>
      <div class="card-body">   
 <form action="" method="POST">
                  ...
                  <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="supcode">Supplier Code:</label>
                       ...
                       <input class="form-control input-sm" id="supcode" name="SUPCODE" placeholder=
                            " Code" type="text" value="<?php echo $fetch['sellercode']?>"  readonly>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="form-row">
                      ...
                      <label for="SUPNAME">Supplier Name:</label>
                       <input class="form-control input-sm" id="SUPNAME" name="sellername" value="<?php echo $fetch['sellername']?>"  placeholder=
                 ...
                 <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="SUPTIN">Supplier TIN:</label>
                       <input class="form-control input-sm" id="SUPTIN" name="sellertin" value="<?php echo $fetch['seller_tin']?>" placeholder=
                            " TIN" type="text" >
                      </div>
                    </div>
                  </div>
                 ...
                 <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="SUPADD">Supplier Address:</label>
                       <input class="form-control input-sm" id="SUPADD" name="selleraddress" value="<?php echo $fetch['seller_address']?>" placeholder=
                            " Address" type="text" >
                      </div>
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="SUPTIN">Supplier Contact:</label>
                       <input class="form-control input-sm" id="SUPCONTACT" name="sellercontact" value="<?php echo $fetch['seller_phone']?>" placeholder=
                            " Contact" type="text" >
                      </div>
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    <div class="form-row">
                      ...
                      <label for="SUPREMARKS"> Remarks:</label>
                       <input class="form-control input-sm" id="SUPREMARKS" name="sellermarks" value="<?php echo $fetch['seller_remarks']?>" placeholder=
                            " Remarks" type="text" >
                      </div>
                    </div>
                  </div>
            ...
            <button class="btn btn-primary btn-block" name="update_seller" type="submit" ><span class="glyphicon glyphicon-floppy-save"></span> Update Supplier</button>
...
$conn->query("UPDATE `seller` SET `sellername`='$SellerName',`seller_tin`='$SellerTin',`seller_address`='$SellerAddress' ,`seller_phone`='$SellerContact',`seller_remarks`='$SellerMarks' WHERE `seller_id` = '$ID'") or die(mysqli_error());

echo " <script>window.alert('successful Expensis Updated');window.location='viewSeller.php'</script>";
